...
const PlaceCard = ({ placeDetails }) => {
  ...
  const getImage = (photos) => {
    ...
    return `https://maps.googleapis.com/maps/api/place/photo?maxwidth=960&photoreference=${photos[0].photo_reference}&key=AIzaSyCEamG2dWQtxCaNKJ_xHKI7_iqtXUG9r_s`;
  }
