...
const SPOONACULAR_API_KEY = "2b97c9249ccb4b07b46014aa9eb05c71";
...
class Cuisine extends Component {
    ...
    getSpoonacularRecipes = async (e) => {
        const api_call = await fetch(`https://api.spoonacular.com/recipes/complexSearch?cuisine=${this.props.cuisine}&number=20&addRecipeInformation=true&apiKey=${SPOONACULAR_API_KEY}`);
        const result = await api_call.json();
